                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="flex items-center justify-between space-x-3">
                    <input
                      ...
                      max="20"
                      step="2"
                      value={tempOptions.coarseGridInterval}
                      onChange={(e) => {
                        const v = parseInt(e.target.value);
                        handleOptionChange('coarseGridInterval', v);
                        handleOptionChange('fineGridInterval', Math.floor(v / 2));
                      }}
                    ...
                    <span className="flex items-center justify-center min-w-[40px] text-sm font-medium text-gray-900 dark:text-gray-100">
                      {tempOptions.coarseGridInterval}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="flex items-center justify-between space-x-3">
                    <input
                      ...
                      max="10"
                      step="1"
                      value={tempOptions.fineGridInterval}
                      disabled
                      className="w-full h-2 bg-gray-100 rounded-lg appearance-none cursor-not-allowed dark:bg-gray-600 opacity-50"
                    />
                    <span className="flex items-center justify-center min-w-[40px] text-sm font-medium text-gray-400 dark:text-gray-500">
                      {tempOptions.fineGridInterval}
                    </span>
                  </div>
                </div>
